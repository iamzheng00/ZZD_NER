...
recordFileName = '_'.join(['record_3L_reptile+' + mod, str(inner_iters) + 'i', str(e) + 'e'])
...
vali_train_batches = get_batches_v3(train_data_path_list=vali_train_data_paths, batch_size=200, batch_num=1,
...
for epoch in range(epochNum, epochNum + 500):
    ...
    # 验证阶段 测试NER模型
    vali_test_batch = vali_test_batches[0]
